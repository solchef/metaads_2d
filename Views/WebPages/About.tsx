  ...
  return (
    <Fragment>
      <div className="card-body m-3">
        ...
        <img
          className="image-border mb-4"
          src="assets/images/step-3-min.png"
          width={'100%'}
          alt="quad"
        />
      ...
      <div className="card-body  m-3">
        ...
        <h5 className="pb-2 text-primary mt-4">
          {' '}
        ...
        <p>
          Each pixel you own tied to the ownership or holder of the TMDW nft
          will grant you access to any image, input a URL domain and even name
          the specific pixels.
        </p>
        <p>
          Since we are building towards a fully decentralized system everything
          in uncensored we are for the liberty of the people. You can post about
          yourself, your business, a crypto project, you’re nft.
        </p>
        <p>
          Anything you like! Through the partnership with Quadspace each pixel
          will come with its own meta land. Here you can get creative and design
          anything you like.
        </p>
        <p>
          So that when people click on your pixel it gives them the option to
        ...
        <p className="w-100">
          ...
          pixels on the web for $1 each.
        </p>
        <p>
          Back then the web was still very static and there were no digital
          native forms of transacting value so when pixels were bought and set,
          they could no longer be re-sold or updated.
        </p>
        <p>
        ...
        <p>
          TMDW infuses these modern innovations into the original idea to build
          a much more fun and functional virtual space to share content on
          anything you like!{' '}
        </p>
        ...
        <p>
          ...
          or bought second-hand from someone who's already minted it.
        </p>
        <p>
          Once owned, you can put any image within that block, along with a
          title, description and url to another website! To mint new blocks and
          make use of Ethereum and Web3 technologies you need to have a Web3
          enabled plugin like{' '}
          <a
            target="_blank"
            rel="noopener noreferrer"
        ...
        <p>
          ...
          that's not yet been minted and confirm the transaction.
        </p>
        <p>
          Once you own the NFT that represents a block you can then change the
          image, title, description and url by clicking it and selecting "update
          token" on the side-panel.
        </p>
        <p>
          By connecting your wallet the site will recognize that you own that
          NFT and allow you to update the content associated with that block.
        </p>
        <p>
          And it's a simple as that, buy blocks as NFTs then share your NFTs,
          projects and creations in this digital content space with the entire
          world!
        </p>
