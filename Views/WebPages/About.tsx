...
export const About = () => {
  return (
    <Fragment>
      ...
      <h5 className="pb-2 text-primary"><i>ABOUT US</i> </h5>
      <p>
      ...
      <p>
        Each pixel on the Meta-Board will also come with 1 parcel of land in the
        Quadspace metaverse as a BONUS!
      </p>
      ...
      <p>
        Each pixel you own tied to the ownership or holder of the TMDW nft will
        grant you access to any image, input a URL domain and even name the
        specific pixels.
      </p>
      <p>
        Since we are building towards a fully decentralized system everything in
        uncensored we are for the liberty of the people. You can post about
      ...
      <p>
        So that when people click on your pixel it gives them the option to jump
      ...
      <p>
        Back then the web was still very static and there were no digital native
        forms of transacting value so when pixels were bought and set, they
        could no longer be re-sold or updated.
      </p>
      <p>
      ...
      <p>
        TMDW infuses these modern innovations into the original idea to build a
        much more fun and functional virtual space to share content on anything
        you like!{' '}
      </p>
      ...
      <p>
        ...
        bought second-hand from someone who's already minted it.
      </p>
      <p>
        Once owned, you can put any image within that block, along with a title,
      ...
      <p>
        By connecting your wallet the site will recognize that you own that NFT
        and allow you to update the content associated with that block.
      </p>
      <p>
