            ...
            <div className="col pt-5">
              <h6>
                <span className="gradiant">
                  SHAPING THE FUTURE OF META-COMMERCIAL REALTY
                </span>
              </h6>
              <h1>
                1M <span className="gradiant">QUADSPACE</span> FOR GRAB OWN
                METASTATE FOR $1
              </h1>
              <p>
                {' '}
                Quadspace metaverse allows businesses, meta realtors and
                individual NFT collectors to acquire Quad for $1. These estate
                can be used as space, 3d retail space or simply a place for you
                and your meta buddies to kick it!
              </p>
              <Link href="/space">
                <a className="btn-primary hoverable btn-sm">
            ...
            >
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <h2>Phase 1</h2>
                  <p>
                    1 million NFT parcel presale as begun at $1 each. Each
                    parcel are 10 x 10px square.
                  </p>
                  <hr />
                ...
                <div className="carousel-item">
                  <h2>Phase 2</h2>
                  <p>
                    Public on opensea.io for $10 each. Parcels can be divided,
                    sold or used as a clickable ad.{' '}
                  </p>
                  <hr />
                  <div className="d-flex flex-column">
                    <div className="d-flex align-items-center mb-3">
                ...
                <div className="carousel-item">
                  <h2>Phase 3</h2>
                  <p>
                    Convert parcels into sq.ft. with our 3D Builder &amp; offer
                    an immersive virtual 3D retail space.
                  </p>
                  <hr />
                  <div className="d-flex flex-column">
                    <div className="d-flex align-items-center mb-3">
