...
const AdSpace: React.FunctionComponent = () => {
  const { cAreaRef, zoomIn, zoomOut, addSelector, squreInfo } =
    useCanvas()
            ...
            <div className="d-flex flex-row-inverse justify-content-between align-items-center wrap-flow">
              <div className="buttons d-flex flex-row ">
                <div>
                  ...
                  <button onClick={offcanvasLeft}  className="btn hoverable btn-primary purp-btn btn-lg btn-buy"><i className="bi-cart " /></button>
                </div>

                <button className="col hoverable hide-mobile btn btn-primary purp-btn btn-lg " ><i className="bi bi-border " /></button>
                <button className="col hoverable hide-mobile btn btn-primary purp-btn btn-lg " ><i className="bi bi-signpost-fill " /></button>
                <button className="col hoverable hide-mobile btn btn-primary purp-btn btn-lg " ><i className="bi bi-image " /></button>
                <button className="col hoverable hide-mobile btn btn-primary purp-btn btn-lg " ><i className="bi bi-box " /></button>
              </div>
              <div className="buttons ">
                <button onClick={offcanvasRight} className="btn hoverable btn-primary btn-lg"><i className="bi bi-hand-index " /></button>
                <button  className="btn hoverable btn-primary btn-lg ">
                  <i className="bi-arrow-clockwise " />
                </button><button onClick={() => addSelector()} className="btn btn-primary btn-lg hoverable">
                  <i className="bi-arrows-move " />
                </button><button   onClick={() => zoomIn()} className="btn btn-primary btn-lg hoverable"> <i className="bi-zoom-out " />
                </button>
                <button   onClick={() => zoomOut()} className="btn btn-primary btn-lg hoverable">
