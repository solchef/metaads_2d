...
const FormFour = (props) => {
  return (
    <>
      ...
      <button className="btn-primary btn-lg w-100 buy-lot hoverable mt-1"  ><i className="bi-cart me-2 " />
     BUY LOT </button>
...
<div className="btn-slide text-nowrap mt-3">
            ...
            <span className=' pe-2'><img src="assets/images/square_icon.png" width="20px"/> : 1 </span>
            <span className='text-nowrap pe-2'> <b><i className="bi bi-tag"></i> : </b>
              <svg
       ...
       <span className=' pe-2'><i className='bi bi-border '></i> : ( 1 x 1 )</span>
       <span className="pe-2"><i className='bi bi-geo-alt'></i> 1X , 1Y </span>
