...
export default class Experience {
  ...
  setConfig() {
    ...
    this.config.height = boundings.height / 1.5 || window.innerHeight
  ...
  setDebug() {
    if (this.config.debug) {
      ...
      this.debug.containerElem_.style.top = '300px'
    }
  }
  ...
  setScene() {
    ...
    // const helper = new THREE.DirectionalLightHelper(this.pointLight, 10)
    // this.pointLight.position.set(0, 1, 0)
    // this.pointLight.castShadow = true
    // console.log(helper)
    // console.log(this.pointLight.shadow)
    ...
    // this.pointLight.shadow.camera.far = 5000
    // this.pointLight.up.y = 100
    // this.pointLight.shadow.camera.position.x = 10
    // this.pointLight.shadow.camera.position.y = 10
    // this.pointLight.shadow.camera.position.z = 10
  }
