  ...
  return (
    <>
      <nav
        className={`navbar ${
          showMenu && ' active'
        }  sticky-top d-flex navbar-dark bg-dark  `}
      >
                ...
                <div className="position-absolute menu-top">
                  {!menu ? (
                    ...
                    <>
                      ...
                      >
                        {' '}
                        <i className="icon-menu bi bi-info-circle me-4"></i>{' '}
                      ...
                      >
                        {' '}
                        <i className="icon-menu bi bi-map  me-4"></i>{' '}
                      ...
                      <a
                        ...
                        target="_blank"
                        href={
                          'https://opensea.io/collection/themilliondollarwebsite'
                        }
                      >
                        <button className="btn text-start  btn-primary mt-2 py-2 w-100">
                          ...
                          <span className="me-3">MarketPlace</span>
                        </button>{' '}
                        <br />
                      </a>
                      <a
                      ...
                      >
                        ...
                        <button className="btn text-start  btn-primary mt-2 py-2 w-100">
                          {' '}
                          <i className="bi bi-telegram me-4"></i>{' '}
                          <span className="me-3">Telegram</span>{' '}
                        </button>
                      </a>{' '}
                      <br />
                      <a
